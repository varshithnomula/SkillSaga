...
const AddCourse = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div key={chapterIndex} className="bg-white border rounded-1g mb-2 mt-2">
        ...
        <div className='flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer mt-2'
