...
exports.SettingsInternalInSerializer = void 0;
...
exports.SettingsInternalInSerializer = {
    _fromJsonObject(object) {
        return {
            colorPaletteDark: object["colorPaletteDark"]
                ? customColorPalette_1.CustomColorPaletteSerializer._fromJsonObject(object["colorPaletteDark"])
                : undefined,
            colorPaletteLight: object["colorPaletteLight"]
                ? customColorPalette_1.CustomColorPaletteSerializer._fromJsonObject(object["colorPaletteLight"])
                : undefined,
            ...
            customStringsOverride: object["customStringsOverride"]
                ? customStringsOverride_1.CustomStringsOverrideSerializer._fromJsonObject(object["customStringsOverride"])
                : undefined,
            customThemeOverride: object["customThemeOverride"]
                ? customThemeOverride_1.CustomThemeOverrideSerializer._fromJsonObject(object["customThemeOverride"])
                : undefined,
    ...
    _toJsonObject(self) {
        return {
            colorPaletteDark: self.colorPaletteDark
                ? customColorPalette_1.CustomColorPaletteSerializer._toJsonObject(self.colorPaletteDark)
                : undefined,
            colorPaletteLight: self.colorPaletteLight
                ? customColorPalette_1.CustomColorPaletteSerializer._toJsonObject(self.colorPaletteLight)
                : undefined,
            ...
            customStringsOverride: self.customStringsOverride
                ? customStringsOverride_1.CustomStringsOverrideSerializer._toJsonObject(self.customStringsOverride)
                : undefined,
            customThemeOverride: self.customThemeOverride
                ? customThemeOverride_1.CustomThemeOverrideSerializer._toJsonObject(self.customThemeOverride)
                : undefined,
...
//# sourceMappingURL=settingsInternalIn.js.map